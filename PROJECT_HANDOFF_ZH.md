...
| 最新安装包 | `Distribution/FCP-Cleaner-3.9.2-universal.dmg` |
...
8. 单个资源库可清理空间低于固定的 200 MB 时自动跳过（2026-08 由 500 MB 下调，产品决策）。
